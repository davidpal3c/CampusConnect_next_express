...
import { ArticleCard } from "@/app/components/PageComponents/User/Articles/ArticleCard";
import Loader from "@/app/components/Loader/Loader"; 

import { fetchRecentArticles, fetchRecentEvents } from "@/app/pages/user/dashboardFetch";
...
export default function UserDashboard() {
  ...
  const authorizedPage = (
    <main className="m-8 flex-col text-saitBlack">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-y-12 gap-x-6 mt-4">
        {events.map((event) => (
