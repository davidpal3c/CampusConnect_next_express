...
export function ArticleCard(props: ArticleInterface) {
    ...
    return (  
        <div className="border-gray-100 rounded-2xl shadow-lg border-2">
                    ...
                    <div className="flex flex-col items-center mb-4">
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            <div className="ml-auto text-right">
                                ...
                                <p className="lg:text-sm text-gray-500 italic">Author: {author}</p>
                            </div>
                        </div>

                    </div>
                    <p className="align-middle">{content.split(" ").length > 50
