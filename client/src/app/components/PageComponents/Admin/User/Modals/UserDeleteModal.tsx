...
export default function UserDeleteModal({ usersData, userIds, noEditor, openDeleteModal, handleDeleteModalClose, closeUserEditor, reFetchUsers }: UserDeleteMultipleModalProps) {
    ...
    const processDeleteUser = async (userIds: string[]) => {
        try {
            ...
            if (response.error) {
                toast.error(response.error || 'An error occurred deleting user.');
