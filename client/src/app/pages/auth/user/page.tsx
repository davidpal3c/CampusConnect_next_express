...
import UserLogin from "@/app/components/PageComponents/Auth/User/UserLogin";


export default function UserLoginPage() {
    return (
        <div className="bg-side-red-gradient">
            <UserLogin />
        </div>
    );
}
...
//                         <a href="#" className="text-saitWhite text-md underline hover:text-saitWhite">Forgot Password?</a>
//                         <button
//                             type="submit"
//                             className="bg-saitDarkRed text-saitWhite font-bold py-2 px-8 rounded-xl hover:bg-opacity-60 focus:outline-none"
//                         >
//                             Login Now
//                         </button>
//                     </div>
